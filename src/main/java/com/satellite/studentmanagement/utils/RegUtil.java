package com.satellite.studentmanagement.utils;
...
public class RegUtil {
     ...
     * 判断是否为合法的图片格式
     */
    public static boolean isLegalPictureFormat(String pictureFileFormat) {
        String regex = "(?i)^.*\\.(jpg|jpeg|png|gif|bmp|tiff|webp)$";
        return Pattern.matches(regex, pictureFileFormat);
    }
}
